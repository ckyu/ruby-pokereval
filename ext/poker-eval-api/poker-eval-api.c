...
int StdDeck_OmahaHiLow8_EVAL(StdDeck_CardMask hole, StdDeck_CardMask board,
...
HandVal StdDeck_OmahaHi_EVAL(StdDeck_CardMask hole, StdDeck_CardMask board) {
  HandVal hival; 
  int ret = StdDeck_OmahaHiLow8_EVAL(hole, board, &hival, NULL);
  return hival;
}
